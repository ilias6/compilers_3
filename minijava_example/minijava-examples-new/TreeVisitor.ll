...
@.TreeVisitor = global [0 x i8*] []

@.TV = global [1 x i8*] [i8* bitcast (i32 (i8*)* @TV.Start to i8*)]

@.Tree = global [21 x i8*] [i8* bitcast (i1 (i8*, i32)* @Tree.Init to i8*),
...
@.Visitor = global [2 x i8*] [i8* bitcast (i32 (i8*, i8*)* @Visitor.visit to i8*),
	i8* bitcast (i32 (i8*, i32)* @Visitor.foo to i8*)]

@.MyVisitor = global [3 x i8*] [i8* bitcast (i32 (i8*, i8*)* @MyVisitor.visit to i8*),
	i8* bitcast (i32 (i8*, i32)* @MyVisitor.foo to i8*),
	i8* bitcast (i32 (i8*)* @MyVisitor.fa to i8*)]
...
define i32 @main (i8** %a) {
	...
	%_3 = getelementptr [1 x i8*], [1 x i8*]* @.TV, i32 0, i32 0
	store i8** %_3, i8*** %_2
...
define i32 @TV.Start(i8* %this) {
	...
	%_8 = getelementptr [21 x i8*], [21 x i8*]* @.Tree, i32 0, i32 0
	store i8** %_8, i8*** %_7
	...
	%_17 = add i32 0, 16
	%_16 = call i1 %_15(i8* %_10, i32 %_17)
	...
	%_35 = add i32 0, 8
	%_34 = call i1 %_33(i8* %_28, i32 %_35)
	...
	%_44 = add i32 0, 24
	%_43 = call i1 %_42(i8* %_37, i32 %_44)
	...
	%_48 = load i8**, i8*** %_47
	%_49 = getelementptr i8*, i8** %_48, i32 12
	%_50 = load i8*, i8** %_49
	%_51 = bitcast i8* %_50 to i1 (i8*, i32)*
	%_53 = add i32 0, 4
	%_52 = call i1 %_51(i8* %_46, i32 %_53)
	...
	%_57 = load i8**, i8*** %_56
	%_58 = getelementptr i8*, i8** %_57, i32 12
	%_59 = load i8*, i8** %_58
	%_60 = bitcast i8* %_59 to i1 (i8*, i32)*
	%_62 = add i32 0, 12
	%_61 = call i1 %_60(i8* %_55, i32 %_62)
	...
	%_66 = load i8**, i8*** %_65
	%_67 = getelementptr i8*, i8** %_66, i32 12
	%_68 = load i8*, i8** %_67
	%_69 = bitcast i8* %_68 to i1 (i8*, i32)*
	%_71 = add i32 0, 20
	%_70 = call i1 %_69(i8* %_64, i32 %_71)
	...
	%_80 = add i32 0, 28
	%_79 = call i1 %_78(i8* %_73, i32 %_80)
	...
	%_84 = load i8**, i8*** %_83
	%_85 = getelementptr i8*, i8** %_84, i32 12
	%_86 = load i8*, i8** %_85
	%_87 = bitcast i8* %_86 to i1 (i8*, i32)*
	%_89 = add i32 0, 14
	%_88 = call i1 %_87(i8* %_82, i32 %_89)
	...
	%_93 = load i8**, i8*** %_92
	%_94 = getelementptr i8*, i8** %_93, i32 18
	%_95 = load i8*, i8** %_94
	%_96 = bitcast i8* %_95 to i1 (i8*)*
	%_97 = call i1 %_96(i8* %_91)
	
	store i1 %_97, i1* %_1
	%_98 = add i32 0, 100000000
	...
	%_103 = getelementptr [3 x i8*], [3 x i8*]* @.MyVisitor, i32 0, i32 0
	store i8** %_103, i8*** %_102
	
	store i8* %_101, i8** %_3
	%_104 = add i32 0, 50000000
	call void (i32) @print_int(i32 %_104)
	%_105 = load i32, i32* %_2

	%_106 = load i8*, i8** %_0
	%_107 = bitcast i8* %_106 to i8***
	%_108 = load i8**, i8*** %_107
	%_109 = getelementptr i8*, i8** %_108, i32 20
	%_110 = load i8*, i8** %_109
	%_111 = bitcast i8* %_110 to i32 (i8*, i8*)*
	%_113 = load i8*, i8** %_3
	%_112 = call i32 %_111(i8* %_106, i8* %_113)
	
	store i32 %_112, i32* %_2
	%_114 = add i32 0, 100000000
	call void (i32) @print_int(i32 %_114)

	%_115 = load i8*, i8** %_0
	%_116 = bitcast i8* %_115 to i8***
	%_117 = load i8**, i8*** %_116
	%_118 = getelementptr i8*, i8** %_117, i32 17
	%_119 = load i8*, i8** %_118
	%_120 = bitcast i8* %_119 to i32 (i8*, i32)*
	%_122 = add i32 0, 24
	%_121 = call i32 %_120(i8* %_115, i32 %_122)
	call void (i32) @print_int(i32 %_121)

	%_123 = load i8*, i8** %_0
	%_124 = bitcast i8* %_123 to i8***
	%_125 = load i8**, i8*** %_124
	%_126 = getelementptr i8*, i8** %_125, i32 17
	%_127 = load i8*, i8** %_126
	%_128 = bitcast i8* %_127 to i32 (i8*, i32)*
	%_130 = add i32 0, 12
	%_129 = call i32 %_128(i8* %_123, i32 %_130)
	call void (i32) @print_int(i32 %_129)

	%_131 = load i8*, i8** %_0
	%_132 = bitcast i8* %_131 to i8***
	%_133 = load i8**, i8*** %_132
	%_134 = getelementptr i8*, i8** %_133, i32 17
	%_135 = load i8*, i8** %_134
	%_136 = bitcast i8* %_135 to i32 (i8*, i32)*
	%_138 = add i32 0, 16
	%_137 = call i32 %_136(i8* %_131, i32 %_138)
	call void (i32) @print_int(i32 %_137)

	%_139 = load i8*, i8** %_0
	%_140 = bitcast i8* %_139 to i8***
	%_141 = load i8**, i8*** %_140
	%_142 = getelementptr i8*, i8** %_141, i32 17
	%_143 = load i8*, i8** %_142
	%_144 = bitcast i8* %_143 to i32 (i8*, i32)*
	%_146 = add i32 0, 50
	%_145 = call i32 %_144(i8* %_139, i32 %_146)
	call void (i32) @print_int(i32 %_145)

	%_147 = load i8*, i8** %_0
	%_148 = bitcast i8* %_147 to i8***
	%_149 = load i8**, i8*** %_148
	%_150 = getelementptr i8*, i8** %_149, i32 17
	%_151 = load i8*, i8** %_150
	%_152 = bitcast i8* %_151 to i32 (i8*, i32)*
	%_154 = add i32 0, 12
	%_153 = call i32 %_152(i8* %_147, i32 %_154)
	...
	%_159 = getelementptr i8*, i8** %_158, i32 13
	%_160 = load i8*, i8** %_159
	%_161 = bitcast i8* %_160 to i1 (i8*, i32)*
	%_163 = add i32 0, 12
	%_162 = call i1 %_161(i8* %_156, i32 %_163)
	...
	%_168 = getelementptr i8*, i8** %_167, i32 18
	...
	%_179 = add i32 0, 12
	%_178 = call i32 %_177(i8* %_172, i32 %_179)
...
define i1 @Tree.Insert(i8* %this, i32 %v_key) {
	...
	%_9 = getelementptr [21 x i8*], [21 x i8*]* @.Tree, i32 0, i32 0
	store i8** %_9, i8*** %_8
...
define i32 @Visitor.visit(i8* %this, i8* %n) {
	...
	%_12 = bitcast i8* %_11 to i8***
	%_13 = load i8**, i8*** %_12
	%_14 = getelementptr i8*, i8** %_13, i32 3
	%_15 = load i8*, i8** %_14
	%_16 = bitcast i8* %_15 to i8* (i8*)*
	%_17 = call i8* %_16(i8* %_11)
	...
	%_20 = bitcast i8* %_19 to i8***
	%_21 = load i8**, i8*** %_20
	%_22 = getelementptr i8*, i8** %_21, i32 20
	%_23 = load i8*, i8** %_22
	%_24 = bitcast i8* %_23 to i32 (i8*, i8*)*
	%_25 = call i32 %_24(i8* %_19, i8* %this)
	
	store i32 %_25, i32* %_0
	br label %if_end_0
	...
	br i1 %_34, label %if_then_1, label %if_else_1
	...
	%_47 = bitcast i8* %_46 to i8***
	%_48 = load i8**, i8*** %_47
	%_49 = getelementptr i8*, i8** %_48, i32 20
	%_50 = load i8*, i8** %_49
	%_51 = bitcast i8* %_50 to i32 (i8*, i8*)*
	%_52 = call i32 %_51(i8* %_46, i8* %this)
	
	store i32 %_52, i32* %_0
	br label %if_end_1
...
define i32 @Visitor.foo(i8* %this, i32 %i) {
	%__i = alloca i32
	store i32 %i, i32* %__i
	%_0 = add i32 0, 0
	ret i32 %_0
...
define i32 @MyVisitor.visit(i8* %this, i8* %n) {
	...
	br i1 %_41, label %if_then_1, label %if_else_1
	...
	%_55 = load i8**, i8*** %_54
	%_56 = getelementptr i8*, i8** %_55, i32 20
	%_57 = load i8*, i8** %_56
	%_58 = bitcast i8* %_57 to i32 (i8*, i8*)*
	%_59 = call i32 %_58(i8* %_53, i8* %this)
	
	store i32 %_59, i32* %_0
	br label %if_end_1
...
define i32 @MyVisitor.fa(i8* %this) {
...
define i32 @MyVisitor.foo(i8* %this, i32 %i) {
	%__i = alloca i32
	store i32 %i, i32* %__i
	%_0 = load i32, i32* %__i
	ret i32 %_0
